...
//        }
    ...
    //insert node in tree
        ...
        public void insertnode(String value){   //here we are inserting a node only to the leaf nodes using levelorder
             ...
             while (!queue.isEmpty()){
                 ...
                 if(presentNode.left == null){
                     ...
                     queue.add(presentNode.left); //if all nodes is full of childs then we have to create new childs to present node so that we can add our value
                     queue.add(presentNode.right);
                 }
        ...
        //get deepest node ||we are doing this cause suppose we have to delete internal node of tree if we delete that node then that node have some children so we are setting parent of that children node as deepest node and after that the deppest node deleted from tree   
     ...
     //Delete deepest node
        ...
        public void deleteDeepestNode(){
         ...
         while (!queue.isEmpty()){
             ...
             previousNode = currNode; //we need 2nodes 1 st node and 2nd node to decide which one nodes child have deepest node
             currNode = queue.remove();

             if (currNode.left == null){
                 previousNode.right = null;  //consider we are at nodeN5(i.e N5.left == null N5.right == null) then we have to set nodeN4.right child to null because we are deleting deepest node  n1
                                             /*     /\
                                                   n2 n3
                                                  /\    /\
                                                 n4 n5 n6 n7
