...
public class AVLTree {
    ...
    private BinaryNode rotateRight(BinaryNode disbalancedNode){
        ...
        disbalancedNode.left = disbalancedNode.left.right; //here we actually setting 1 disbalanced node's left child =
    ...
    public BinaryNode deleteNode(BinaryNode node , int value){
        ...
        int balance = getBalanced(node);
        if (balance >1 && getBalanced(node.left)>= 0){ //here ex.1-0 =1 or 1-1=0
            return rotateRight(node); //this is LL condn
        }
